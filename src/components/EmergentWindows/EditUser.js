...
export default function EditUser({ i, u, currentInfo }) {
                            ...
                            <form autoComplete='off' onSubmit={handleSubmit(onSubmit)} className="p-fluid w-full">
                                ...
                                <div className="field">
                                    <span className="p-float-label p-input-icon-right">
                                        ...
                                        <Controller defaultValue={currentInfo.email} name="email" control={control}
                                ...
                                <div className="field">
                                    <span className='p-inline-label'>
                                        ...
                                        <Controller defaultValue={currentInfo.status === true ? 'Activo' : 'Inactivo'} name="status" control={control}
                                            render={({ field, fieldState }) => (
